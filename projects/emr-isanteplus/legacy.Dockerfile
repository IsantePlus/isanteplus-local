...
COPY ./distribution/openmrs_modules-legacy /openmrs/distribution/openmrs_modules
COPY ./distribution/openmrs_webapps/legacy-openmrs.war /openmrs/distribution/openmrs_webapps/openmrs.war
