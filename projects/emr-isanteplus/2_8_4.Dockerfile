...
COPY ./distribution/openmrs_modules-2.8.4 /openmrs/distribution/openmrs_modules
COPY ./distribution/openmrs_webapps/openmrs.war /openmrs/distribution/openmrs_webapps/openmrs.war
